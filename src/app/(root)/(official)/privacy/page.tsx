  ...
  return (
    <div className="w-full h-full">
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Chatio, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Chatio.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Chatio, accessible from{" "}
            <a
              href="https://chatio-sage.vercel.app/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://chatio-sage.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: aaronp.saji1233@gmail.com</li>
      </ul>
    </div>
  );
};
